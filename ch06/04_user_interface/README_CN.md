# 构建 GPT 基垃圾邮件分类器的用户界面


此奖励文件夹包含运行 ChatGPT 风格用户界面的代码，用于与第 6 章的微调 GPT 基垃圾邮件分类器进行交互，如下图所示。
...
此文件加载并使用我们在第 6 章生成的 GPT-2 分类器权重。这要求您首先执行 [`../01_main-chapter-code/ch06.ipynb`](../01_main-chapter-code/ch06.ipynb) 文件。
