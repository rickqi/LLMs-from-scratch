...
> 最终更新：2026-06-17，15组实验完成

| 数据 | stocks | 模型 | RankIC | DirAcc | 训练 |
|------|--------|------|--------|--------|------|
| **半导体 + 长历史(2005-2026)** | **68** | **LSTM** | **+0.205** | **59.3%** | 3min |
| 半导体 (2018-2026) | 68 | LSTM | +0.13 | 50.0% | 27s |
| 全半导体 | 143 | LSTM | +0.01 | 49.2% | 90s |
| Kronos-small 预训练 | 68 | Transformer | -0.016 | 56.7% | 2h |
| CSI300 | 329 | LSTM | -0.043 | 49.7% | 85s |

> 结论：板块集中 × 长历史 × 简单模型 = 最优 RankIC

### 变更记录

| 日期 | 变更 |
|------|------|
| 2026-06-17 | **全半导体194只** Tushare下载 + 训练, RankIC=+0.01 |
| 2026-06-17 | **长历史突破**: Kronos/data→2005年, RankIC +0.13→+0.205 (+58%) |
| 2026-06-17 | **Tushare CSI300 全量**: 329 stocks, 817k rows, 2005-2026 |
| 2026-06-17 | **LSTM A/B集成**: model/lstm_model.py, 三阶段执行方案 |
