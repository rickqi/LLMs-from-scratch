...
| COS 备份 | ✅ | 模型+数据已备份 |
| 波动率信号 | 🆕 | Sharpe 2.48 (top-k=20, 需更长验证) |
...
| # | 行动 | 预期 | 状态 |
|---|------|------|------|
| 1 | **波动率信号优化** — 参数网格搜索 | 稳定 Sharpe > 1.5 | 🆕 进行中 |
| 2 | **扩展半导体** — Tushare 全板块 | 更长验证 | ⏳ |
| 3 | **集成模型** — 方向+波动率+LSTM | 提升稳健性 | ⏳ |

**信号验证结果**: Sharpe 2.48 (top-k=20, 10天调仓) | ⚠️ 仅 17 次调仓，需更长历史。
